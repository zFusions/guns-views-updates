...
| **Installer** | [GunsViews-Setup-1.4.20.exe](https://github.com/zFusions/guns-views-updates/releases/latest/download/GunsViews-Setup-1.4.20.exe) |
...
1. Download **GunsViews-Setup-1.4.20.exe** from [Releases](https://github.com/zFusions/guns-views-updates/releases/latest).
...
| Config lost after update | Upgrade to **1.4.20** or newer - data is stored in `%LOCALAPPDATA%\Guns Views\Data` |
