...
| **Installer** | [GunsViews-Setup-1.2.6.exe](https://github.com/zFusions/guns-views-updates/releases/latest/download/GunsViews-Setup-1.2.6.exe) |
...
1. Download **GunsViews-Setup-1.2.6.exe** from [Releases](https://github.com/zFusions/guns-views-updates/releases/latest).
...
| Config lost after update | Upgrade to **1.2.6** or newer - data is stored in `%LOCALAPPDATA%\Guns Views\Data` |
