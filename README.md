...
| **Installer** | [GunsViews-Setup-1.4.16.exe](https://github.com/zFusions/guns-views-updates/releases/latest/download/GunsViews-Setup-1.4.16.exe) |
...
1. Download **GunsViews-Setup-1.4.16.exe** from [Releases](https://github.com/zFusions/guns-views-updates/releases/latest).
...
| Config lost after update | Upgrade to **1.4.16** or newer - data is stored in `%LOCALAPPDATA%\Guns Views\Data` |
