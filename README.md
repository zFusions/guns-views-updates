...
| **Installer** | [GunsViews-Setup-1.4.17.exe](https://github.com/zFusions/guns-views-updates/releases/latest/download/GunsViews-Setup-1.4.17.exe) |
...
1. Download **GunsViews-Setup-1.4.17.exe** from [Releases](https://github.com/zFusions/guns-views-updates/releases/latest).
...
| Config lost after update | Upgrade to **1.4.17** or newer - data is stored in `%LOCALAPPDATA%\Guns Views\Data` |
